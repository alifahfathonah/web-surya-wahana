        ...
        <div class="container-fluid">
          ...
          <div class="card mb-3">
            <div class="card-header">
              <i class="fas fa-table"></i>  Tambah Produk
          </div>
            <div class="col-lg-6">
              <div class="card">
                <div class="card-body card-block">
                  <form action="add-produk.php" method="post" enctype="multipart/form-data" class="form-horizontal">
                  <!-- Nama -->
                  <div class="row form-group">
                    ...
                    <div class="col-12 col-md-9">
                        <input type="text" id="text-input" name="nama-produk" placeholder="Name" class="form-control" required>
                  ...
                  <div class="row form-group">
                    ...
                    <div class="col-12 col-md-9">
                        <input type="text" id="text-input" name="jenis-produk" placeholder="Type" class="form-control" required>
                  ...
                  <div class="row form-group">
                    ...
                    <div class="col-12 col-md-9">
                      <input type="number" name="harga-produk" id="text-input" placeholder="Price" class="form-control" required>
                    </div>
                  </div>
                  <!-- end form -->
