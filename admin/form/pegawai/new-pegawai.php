        ...
        <div class="container-fluid">
          ...
          <div class="card mb-3">
            <div class="card-header">
              <i class="fas fa-table"></i>  Tambah Pegawai
          </div>
            <div class="col-lg-6">
              <div class="card">
                <div class="card-body card-block">
                  <form action="add-pegawai.php" method="post" enctype="multipart/form-data" class="form-horizontal">
                  <!-- No KTP -->
                  <div class="row form-group">
                    ...
                    <div class="col-12 col-md-9">
                        <input type="number" id="text-input" name="ktp-pegawai" placeholder="ID" class="form-control" required>
                  ...
                  <div class="row form-group">
                    ...
                    <div class="col-12 col-md-9">
                        <input type="text" id="text-input" name="nama-pegawai" placeholder="Name" class="form-control" required>
                  ...
                  <div class="row form-group">
                    ...
                    <div class="col-12 col-md-9">
                        <input type="number" id="text-input" name="notelp-pegawai" placeholder="Phone" class="form-control" required>
                  ...
                  <div class="row form-group">
                    ...
                    <div class="col-12 col-md-9">
                      <textarea name="alamat-pegawai" id="textarea-input" rows="9" placeholder="Address" class="form-control" required></textarea>
                    </div>
                  </div>
                  <!-- end form -->
