        ...
        <div class="container-fluid">
          ...
          <div class="card mb-3">
            <div class="card-header">
              <i class="fas fa-table"></i>  Tambah Mitra
          </div>
            <div class="col-lg-6">
              <div class="card">
                <div class="card-body card-block">
                  <form action="add-mitra.php" method="post" enctype="multipart/form-data" class="form-horizontal">
                  <!-- Nama -->
                  <div class="row form-group">
                    ...
                    <div class="col-12 col-md-9">
                        <input type="text" id="text-input" name="nama-mitra" placeholder="Name" class="form-control" required>
                  ...
                  <div class="row form-group">
                    ...
                    <div class="col-12 col-md-9">
                        <input type="number" id="text-input" name="notelp-mitra" placeholder="Phone" class="form-control" required>
                  ...
                  <div class="row form-group">
                    ...
                    <div class="col-12 col-md-9">
                        <input type="email" id="text-input" name="email-mitra" placeholder="Email" class="form-control" required>
                  ...
                  <div class="row form-group">
                    ...
                    <div class="col-12 col-md-9">
                      <textarea name="alamat-mitra" id="textarea-input" rows="9" placeholder="Address" class="form-control" required></textarea>
                    </div>
                  </div>
                  <!-- end form -->
